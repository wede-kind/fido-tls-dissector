...
You can use the plugin without installing any further dependencies by placing the file "FIDO2_TLS_dissector.lua" together with the file "cbor.lua" from the [lua-cbor Repository](https://github.com/Kristopher38/lua-cbor) in the plugin directory of your Wireshark.
